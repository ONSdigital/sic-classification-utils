...
class EmbeddingHandler:
    ...
    def __init__(
        ...
        self.sic_structure_file = sic_structure_file or config["lookups"]["sic_structure"]
    ...
    def _load_or_build_vector_store(self) -> VectorStore:
